...
A full report provided by CIRCUIT developers is available on the [CIRCUIT Website](https://circuit.org/fake-stake-official-circuit-report/), which includes additional findings, mitigation details, and resources for testing. This type of attack has no risk to users' privacy and does not affect their holdings.
...
A full technical writeup of the protocol can be found [Here](https://circuit.org/wp-content/uploads/2018/11/Zerocoin_Light_Node_Protocol.pdf).
