...
### Users upgrading to this version are encouraged to also read the detailed release notes for the previous [3.1.0](https://github.com/CIRCUIT-Project/CIRCUIT/releases/tag/v3.1.0) release as information will not be duplicated here.
