...
Run with the `-testnet` option to run with "play FARMs (tFARM)" on the test network, if you
...
([`valgrind.supp`](https://github.com/seed2need/seed2need/blob/master/contrib/valgrind.supp))
...
- BitcoinMiner : Generates FARMs (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:SEED2NEED-Project/SEED2NEED.git
