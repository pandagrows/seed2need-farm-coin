...
public:
    ...
    int Seed2needBadBlockTime() const { return nSeed2needBadBlockTime; }
    int Seed2needBadBlocknBits() const { return nSeed2needBadBlocknBits; }
...
protected:
    ...
    unsigned int nSeed2needBadBlocknBits;
