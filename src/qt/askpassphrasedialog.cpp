                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zFARM || context == Context::BIP_38 || context == Context::UI_Vote) {
    ...
    // It doesn't make sense to show the checkbox for sending FARM because you wouldn't check it anyway.
    if (context == Context::Send_FARM || context == Context::Send_zFARM) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR FARM</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("SEED2NEED will close now to finish the encryption process. "
                               ...
                               "your FARMs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
