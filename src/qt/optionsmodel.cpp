...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::FARM);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeSeed2needAmount"))
        SoftSetArg("-anonymizeseed2needamount", settings.value("nAnonymizeSeed2needAmount").toString().toStdString());
