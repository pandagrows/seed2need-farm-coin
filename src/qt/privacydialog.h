...
public:
    ...
    void setZFarmControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzFARM_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzFARM_clicked();
    void on_pushButtonZFarmControl_clicked();
