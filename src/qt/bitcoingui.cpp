                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SEED2NEED Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SEED2NEED address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and seed2need: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zFARM"));
...
//    connect(privacyAction, SIGNAL(triggered()), this, SLOT(gotoPrivacyPage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SEED2NEED Core"), this);
    aboutAction->setStatusTip(tr("Show information about SEED2NEED Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for SEED2NEED"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SEED2NEED addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SEED2NEED addresses"));
    ...
    multisigSpendAction = new QAction(QIcon(":/icons/sendmultisig"), tr("&Multisignature spending..."), this);
    ...
    openAction->setStatusTip(tr("Open a SEED2NEED: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SEED2NEED Core help message to get a list with possible SEED2NEED command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SEED2NEED network", "", count));
}
