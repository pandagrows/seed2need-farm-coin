...
void SEED2NEEDGUI::connectActions() {
    ...
    connect(privacyWidget, &PrivacyWidget::showHide, this, &SEED2NEEDGUI::showHide);
...
void SEED2NEEDGUI::setClientModel(ClientModel* clientModel) {
...
void SEED2NEEDGUI::openFAQ(int section){
    showHide(true);
...
bool SEED2NEEDGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    // Connect actions..
    connect(privacyWidget, &PrivacyWidget::message, this, &SEED2NEEDGUI::message);
    connect(masterNodesWidget, &MasterNodesWidget::message, this, &SEED2NEEDGUI::message);
    connect(coldStakingWidget, &MasterNodesWidget::message, this, &SEED2NEEDGUI::message);
