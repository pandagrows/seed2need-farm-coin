...
#include "qt/seed2need/coincontrolfarmwidget.h"
#include "qt/seed2need/forms/ui_coincontrolfarmwidget.h"

CoinControlFarmWidget::CoinControlFarmWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlFarmWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select FARM Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("FARM");
    ...
    ui->labelValueAfter->setText("0.00 FARM");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 FARM");
    ui->labelValueFee->setText("0.00 FARM");
...
CoinControlFarmWidget::~CoinControlFarmWidget()
{
    delete ui;
}
