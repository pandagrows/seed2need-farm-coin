                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFARMPathCustom = GetArg("-zfarmbackuppath", "");
    ...
    if(!strzFARMPathCustom.empty()) {
        ui->wallet_customzfarmbackuppath->setText(QString::fromStdString(strzFARMPathCustom));
        ui->wallet_customzfarmbackuppath_label->setVisible(true);
        ui->wallet_customzfarmbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFARMPathCustom.empty()) && nCustomBackupThreshold > 0) {
