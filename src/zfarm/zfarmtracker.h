...
#ifndef SEED2NEED_ZFARMTRACKER_H
#define SEED2NEED_ZFARMTRACKER_H
...
public:
    CzFARMTracker(std::string strWalletFile);
    ~CzFARMTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzFARMWallet* zFARMWallet = NULL);
...
#endif //SEED2NEED_ZFARMTRACKER_H
