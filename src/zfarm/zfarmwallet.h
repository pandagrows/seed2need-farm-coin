...
#ifndef SEED2NEED_ZFARMWALLET_H
#define SEED2NEED_ZFARMWALLET_H
...
public:
    CzFARMWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZFARM(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZFARM(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
