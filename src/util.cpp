...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL) {
        ...
        if (ptrCategory.get() == NULL) {
            ...
            // "seed2need" is a composite category enabling all SEED2NEED-related debug output
            if (ptrCategory->count(std::string("seed2need"))) {
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "seed2need.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "seed2needd.pid"));
