...
//        {"blockchain", "getblockindexstats", &getblockindexstats, true, false, false},
        ...
        /* SEED2NEED features */
        {"seed2need", "listmasternodes", &listmasternodes, true, true, false},
        {"seed2need", "getmasternodecount", &getmasternodecount, true, true, false},
        {"seed2need", "masternodeconnect", &masternodeconnect, true, true, false},
        {"seed2need", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"seed2need", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"seed2need", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"seed2need", "masternodecurrent", &masternodecurrent, true, true, false},
        {"seed2need", "masternodedebug", &masternodedebug, true, true, false},
        {"seed2need", "startmasternode", &startmasternode, true, true, false},
        {"seed2need", "createmasternodekey", &createmasternodekey, true, true, false},
        {"seed2need", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"seed2need", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"seed2need", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"seed2need", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"seed2need", "getmasternodescores", &getmasternodescores, true, true, false},
        {"seed2need", "preparebudget", &preparebudget, true, true, false},
        {"seed2need", "submitbudget", &submitbudget, true, true, false},
        {"seed2need", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"seed2need", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"seed2need", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"seed2need", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"seed2need", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"seed2need", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"seed2need", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"seed2need", "checkbudgets", &checkbudgets, true, true, false},
        {"seed2need", "mnsync", &mnsync, true, true, false},
        {"seed2need", "spork", &spork, true, true, false},
        {"seed2need", "getpoolinfo", &getpoolinfo, true, true, false},
...
/*
        ...
        {"zerocoin", "getzfarmseed", &getzfarmseed, false, false, true},
        {"zerocoin", "setzfarmseed", &setzfarmseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzfarm", &searchdzfarm, false, false, true},
        {"zerocoin", "dzfarmstate", &dzfarmstate, false, false, true},
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:14179/\n";
}
