...
extern UniValue DoZfarmSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzfarmseed(const UniValue& params, bool fHelp);
extern UniValue getzfarmseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzfarm(const UniValue& params, bool fHelp);
extern UniValue dzfarmstate(const UniValue& params, bool fHelp);
