...
from fake_stake.base_test import SEED2NEED_FakeStakeTest

class zFARMValidCoinSpendTest(SEED2NEED_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zFARMs..." % DENOM_TO_USE)
